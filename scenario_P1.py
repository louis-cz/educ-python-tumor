...
if __name__ == "__main__":
    ...
    for n_cells_i_val in n_cells_i:
        ...
        for sim_idx in range(n_sim_per_pmax):
            ...
            img_args = { 
                ...
                "img_dir": f"img/SP1_n_cells_i_{n_cells_i_val}" if save_img else None
            }
    ...
    pop_dynamics_RTC.savefig("plots/SP1_impact_n_cells_i_population_RTC.png", dpi=150)
    
    pop_dynamics_STC = pop_vs_time(results, colors=colors_t, pop="stc", prefix="n_cells_i")
    pop_dynamics_STC.savefig("plots/SP1_impact_n_cells_i_population_STC.png", dpi=150)

    pop_dynamics_Immune = pop_vs_time(results, colors=colors_i, pop="immune", prefix="n_cells_i")
    pop_dynamics_Immune.savefig("plots/SP1_impact_n_cells_i_population_Immune.png", dpi=150)
